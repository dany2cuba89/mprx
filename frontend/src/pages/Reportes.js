...
function Reportes() {
  ...
  const manejarExportacion = async (exportFunction, mensajeExito, mensajeError) => {
    try {
      await exportFunction(fechaInicio, fechaFin);
        ...
        <>
          ...
          <button
            onClick={() =>
              manejarExportacion(
                exportarBalanceGeneral,
                "Balance General exportado correctamente.",
                "Error al exportar Balance General."
              )
            }
        ...
        <div className="tabla-container">
          ...
          <button
            onClick={() =>
              manejarExportacion(
                exportarResumenCompras,
                "Resumen de compras exportado correctamente.",
                "Error al exportar resumen de compras."
              )
            }
            className="add-button"
          >
        ...
        <div className="tabla-container">
          ...
          <button
            onClick={() =>
              manejarExportacion(
                exportarPagosEmpleados,
                "Pagos a empleados exportados correctamente.",
                "Error al exportar pagos a empleados."
              )
            }
            className="add-button"
          >
        ...
        <div className="tabla-container">
          ...
          <button
            onClick={() =>
              manejarExportacion(
                exportarProductosMasVendidos,
                "Productos más vendidos exportados correctamente.",
                "Error al exportar productos más vendidos."
              )
            }
            className="add-button"
          >
        ...
        <div className="tabla-container">
          ...
          <button
            onClick={() =>
              manejarExportacion(
                exportarAlertasStockBajo,
                "Alertas de stock bajo exportadas correctamente.",
                "Error al exportar alertas de stock bajo."
              )
            }
            className="add-button"
          >
        ...
        <div className="tabla-container">
          ...
          <button
            onClick={() =>
              manejarExportacion(
                exportarResumenVentas,
                "Resumen de ventas exportado correctamente.",
                "Error al exportar resumen de ventas."
              )
            }
            className="add-button"
          >
